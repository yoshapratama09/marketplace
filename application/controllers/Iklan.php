...
class Iklan extends CI_Controller {
  ...
  public function create()
  {
    ...
    $this->data['harga'] = array(
      ...
      'id'    => 'harga',
      'class' => 'form-control',
      'value' => $this->form_validation->set_value('Harga Basic'),
    );

    $this->data['harga2'] = array(
      'name'  => 'harga2',
      'id'    => 'harga2',
      'class' => 'form-control',
      'value' => $this->form_validation->set_value('Harga Standard'),
    );

    $this->data['harga3'] = array(
      'name'  => 'harga3',
      'id'    => 'harga3',
      'class' => 'form-control',
      'value' => $this->form_validation->set_value('Harga Professional'),
    );
    ...
    $this->data['isi_paket'] = array(
      'name'  => 'isi_paket',
      'id'    => 'isi_paket',
      'class' => 'form-control',
      'value' => $this->form_validation->set_value('Kosongi jika tidak ada'),
    );

    $this->data['isi_paket2'] = array(
      'name'  => 'isi_paket2',
      'id'    => 'isi_paket2',
      'class' => 'form-control',
      'value' => $this->form_validation->set_value('Kosongi jika tidak ada'),
          ...
          if (!$this->upload->do_upload('foto'))
          {
            ...
            else
            {
              ...
              $data = array(
                ...
                'isi_paket2'      => $this->input->post('isi_paket2'),
                'isi_paket3'      => $this->input->post('isi_paket3'),
                'catatan'         => $this->input->post('catatan'),
                'harga'           => clean($this->input->post('harga')),
                'harga2'          => clean($this->input->post('harga2')),
                'harga3'          => clean($this->input->post('harga3')),
                'foto'            => $nmfile,
